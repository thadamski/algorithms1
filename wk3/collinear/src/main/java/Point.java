...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        else if (this.y == that.y && this.x != that.x) return POSITIVE_ZERO;
    ...
    private Comparator<Point> slopeOrderComparator = (Point o1, Point o2) -> {
        Double o1Slope = Point.this.slopeTo(o1);
        Double o2Slope = Point.this.slopeTo(o2);
        int compared = o1Slope.compareTo(o2Slope);
        return compared;
    };
    ...
    public Comparator<Point> slopeOrder() {
        return this.slopeOrderComparator;
    }
